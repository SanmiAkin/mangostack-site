...
import { Pill, Nav, Footer, FinalCTA, useReveal, ForwardEngine } from "../shared.jsx";
    ...
    <div className="ms-container ms-hero__inner ms-hero__inner--split">
      <div className="ms-hero__text">
        ...
        <h1 className="display">
          Senior operators on your<br/>
          hardest problems. <span className="grad-text">Software</span><br/>
          built from what they learn.
        </h1>
        <p className="lede">
        ...
        <div className="ms-hero__stats">
          <div className="stat__line">Built by operators who have led transformation and operations across 14 markets in payments, fintech, and financial services.</div>
        </div>
      </div>
  ...
  return (
    <section className="ms-section ms-motions" ref={ref}>
      <div className="ms-container">
        ...
        <p className="lede">The front line shows us what to build; the software makes the front line faster.</p>
        ...
        <p className="proof-foot" style={{ marginTop: 28 }}>The two feed each other — and each turn compounds. <a href="approach.html">How the studio model works →</a></p>
      </div>
    </section>
  );
};
  ...
  <section className="ms-section ms-proof">
    <div className="ms-container">
      ...
      <div className="proof-row">
        ...
        <a href="workforce-atlas.html" className="proof-item">
          <div className="proof-item__head">
            <Pill kind="soon">LAUNCHING</Pill>
            <span className="proof-item__name">Workforce Atlas</span>
          </div>
          <p className="proof-item__body">An AI workforce audit for UK accounting firms — capacity unlocked, never headcount reduced.</p>
          <span className="proof-item__cta">Read more →</span>
        </a>
